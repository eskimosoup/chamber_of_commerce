module Optimadmin
  class ArticleCategoriesController < Optimadmin::ApplicationController
    ...
    def index
      @article_categories = Optimadmin::BaseCollectionPresenter.new(collection: ArticleCategory.order(:title), view_template: view_context, presenter: Optimadmin::ArticleCategoryPresenter)
    end
