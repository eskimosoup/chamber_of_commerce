module Optimadmin
  class Memberships::PackagesController < ::Optimadmin::BaseController
    ...
    def destroy
      if @package.destroy
        redirect_back(fallback_location: { action: :index }, notice: t('optimadmin.controllers.module.destroy', model_name: ::Memberships::Package.model_name.human))
      else
        redirect_back(fallback_location: { action: :index }, flash: { error: @package.errors.messages[:base].first })
      end
    end
